...
/// ```
///
/// Use `@Directive` to mark a class as an Kelicap directive and provide
...
class Directive {
  ...
  ///
  /// Kelicap only allows directives to trigger on CSS selectors that do not
...
///
/// Each Kelicap component requires a single `@Component` annotation. The
...
class Component {
  ...
  ///
  /// When a component is instantiated, Kelicap creates a change detector, which
  ...
  /// to false.
  ///
  /// &ngsp; (Kelicap space) can be used to insert regular space character into
  /// a template.
