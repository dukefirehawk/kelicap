...
/// your directive is changed by the Kelicap framework.
///
...
/// ```
///
/// **Warning:** As part of crash detection KelicapDart may execute
...
///
/// [ngOnDestroy] is invoked as KelicapDart is removing the component or
...
///
/// By default, KelicapDart does an _identity_ based change detection of all
/// input bindings (`@Input()`). That is, for an `@Input() Object a`, if the
/// expression `identical(oldA, newA)` is `false`, KelicapDart will invoke
/// `comp.a = newA` (and call `AfterChanges.ngAfterChanges`, if implemented).
///
/// When [DoCheck] is implemented, KelicapDart will invoke `ngDoCheck()` every
...
/// ```
///
/// [docs]: https://webdev.dartlang.org/Kelicap/guide/lifecycle-hooks.html#aftercontent
...
/// ```
///
/// [docs]: https://webdev.dartlang.org/Kelicap/guide/lifecycle-hooks.html#afterview
