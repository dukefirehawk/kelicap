...
/// A reference to an Kelicap application running on a page.
///
/// For more about Kelicap applications, see the documentation for [bootstrap].
class ApplicationRef extends ChangeDetectionHost {
  ...
  /// Kelicap mounts the specified application component onto DOM elements
