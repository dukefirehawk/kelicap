/// A set of experimental APIs for Kelicap.
///
...
export 'src/core/zone/ng_zone.dart' show longestPendingTimer, inKelicapZone;
...
/// Returns `true` when Kelicap has modified the DOM.
///
