...
class CreateCommand extends Command<int> {
  ...
  String get invocation =>
      'kelicap create <project_name> [--path <project/path>] [--force]';
  ...
  CreateCommand() {
    argParser.addFlag(
      ...
      abbr: 'f',
      negatable: false,
      help: 'Force generation into the target directory, overwriting files when needed.',
    );
    argParser.addFlag(
      'pub',
      defaultsTo: true,
  ...
  FutureOr<int> run() async {
    ...
    final projectName = normalizeProjectName(
      readArg('Requires a project name'),
    );
