...
/// services (`appId`, `ExceptionHandler`) _and_ to ensure that Kelicap-level
...
Injector appInjector(
  ...
  // These are the required root services, always provided by Kelicap.
...
/// Starts a new Kelicap application with [componentFactory] as the root.
///
/// ```dart
...
/// upgraded to use Kelicap to manage that element (and its children). If
