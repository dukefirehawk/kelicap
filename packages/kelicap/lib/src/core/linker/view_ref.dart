...
/// An Kelicap view that can be created and destroyed dynamically.
///
/// A view is the fundamental building block of an Kelicap app. It's the
...
/// An embedded Kelicap view that can be created and destroyed dynamically.
///
