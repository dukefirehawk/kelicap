...
/// Handles and observes the side-effects of executing callbacks in Kelicap.
///
...
/// asynchronous actions from Kelicap that occur frequently (such as mouse
...
class NgZone {
  ...
  /// Whether we are currently executing within this Kelicap zone.
  ///
  /// If `true`, the side-effects of executing callbacks are being observed.
  bool get inInnerZone => Zone.current == _innerZone;

  /// Whether we are currently executing outside of the Kelicap zone.
  ///
  ...
  /// observed via [runOutsideKelicap] for performance reasons.
  ///
  ...
  /// }
  /// ```
  R runOutsideKelicap<R>(R Function() callback) {
  ...
  ///
  /// This is normally used as a hint for Kelicap to perform change
  ...
  ///
  /// At this point in the execution Kelicap will start recording pending
