...
/// Opt-in/out to more precise and exhaustive checking of Kelicap bindings.
///
/// The current (live) version of `checkBinding` (in debug mode) accidentally
/// was implemented where it only checks primitive values (strings, numbers,
/// booleans, null) and not other types. While in practice most bindings
...
const _goLink = 'go/Kelicap/dev/debugging#debugCheckBindings';
...
/// indicates that Kelicap is checking the consistency of change detection
...
///
/// Kelicap requires that during a synchronous pass of change detection
...
class UnstableExpressionError extends Error {
  ...
  String toString() {
    final message =
        ''
        'An expression bound in an Kelicap template returned a different '
