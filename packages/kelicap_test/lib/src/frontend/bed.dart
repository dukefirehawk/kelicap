...
/// An immutable builder for creating a pre-configured Kelicap application.
///
...
class NgTestBed<T extends Object> {
  ...
  factory NgTestBed(
    ...
    bool watchKelicapLifecycle = true,
  }) {
    if (T == dynamic) {
    ...
    return NgTestBed<T>._useComponentFactory(
      ...
      host: host,
      watchKelicapLifecycle: watchKelicapLifecycle,
    );
  }
  ...
  NgTestBed._useComponentFactory({
    ...
    required bool watchKelicapLifecycle,
  }) : _createStabilizer = watchKelicapLifecycle
           ? _defaultStabilizers
           : _alwaysStable,
       _componentFactory = component;
