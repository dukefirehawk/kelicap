...
/// forms in Kelicap, along with [ControlGroup] and [ControlArray].
///
/// ## Usage
///
...
class Control<T> extends AbstractControl<T> {
  ...
  /// NOTE: Should only be called internally by Kelicap. Use [valueChanges] or
...
/// define forms in Kelicap, along with [Control] and [ControlArray].
...
/// define forms in Kelicap, along with [Control] and [ControlGroup].
