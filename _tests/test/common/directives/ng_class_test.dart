...
extension _CssClasses on Element {
  /// The element's classes as a plain Dart list.
  ///
  /// `classList` is a `DOMTokenList` under `package:web`, which is not
  /// `Iterable` and so cannot be matched against a `List<String>` directly.
  /// Under `dart:html` it was a `CssClassSet`, which was.
