...
void main() {
  ...
  group('DartEmitter', () {
    ...
    test('should declare variables', () {
      ...
      expect(
        emitStmt(
          someVar.set(o.literal(1)).toDeclStmt(null, [
      ...
      expect(
        emitStmt(someVar.set(o.literal(1)).toDeclStmt(o.intType)),
        'int someVar = 1;',
      );
    });
    ...
    test('should support but hide a nullable built-in type', () {
      final nullableString = o.BuiltinType(o.BuiltinTypeName.stringName, [
    ...
    test('should support but hide late + final declaration modifier', () {
      ...
      expect(
        emitStmt(
          writeVarExpr.toDeclStmt(o.stringType, [
          ...
          o.variable('SomeClass').instantiate(
            [
              o.literalMap(
                ...
                o.MapType(o.ArrayType(o.intType), [
                  o.TypeModifier.constModifier,
                ]),
              ),
            ],
    ...
    test('should support function expressions', () {
      ...
      expect(
        emitStmt(o.fn([o.FnParam('param1', o.intType)], []).toStmt()),
        ['(int param1) {', '};'].join('\n'),
      );
    });
    test('should support function statements', () {
      ...
      expect(
        emitStmt(
          o.DeclareFunctionStmt('someFn', [o.FnParam('param1', o.intType)], []),
        ),
        ...
        expect(
          emitStmt(
            o.ClassStmt(
              ...
              null,
              [],
              [o.ClassGetter('someGetter', [], o.intType)],
              null,
              [],
            ),
          ),
    ...
    test('should support builtin types', () {
      ...
      expect(
        emitStmt(writeVarExpr.toDeclStmt(o.dynamicType)),
        'dynamic a = null;',
      );
      ...
      expect(
        emitStmt(writeVarExpr.toDeclStmt(o.functionType)),
        'Function a = null;',
      );
    });
    ...
    test('should support combined types', () {
      ...
      expect(
        emitStmt(writeVarExpr.toDeclStmt(o.ArrayType(o.intType))),
        'List<int> a = null;',
      );
      expect(
      ...
      expect(
        emitStmt(writeVarExpr.toDeclStmt(o.MapType(o.intType))),
