...
import 'package:kelicap_compiler/v1/src/compiler/view_compiler/ir/provider_source.dart';
import 'package:kelicap_compiler/v1/src/compiler/view_compiler/parse_utils.dart'
...
class _ToBindingVisitor
  ...
  ir.Binding visitDirectiveEvent(
    ...
    target: ir.DirectiveOutput(
      ast.memberName,
      context.directive!.analyzedClass!.isMockLike,
    ),
  );
