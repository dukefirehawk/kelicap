...
import 'package:kelicap_compiler/v1/src/compiler/compiler_utils.dart';
import 'package:kelicap_compiler/v1/src/compiler/ir/model.dart' as ir;
import 'package:kelicap_compiler/v1/src/compiler/semantic_analysis/directive_converter.dart';
import 'package:kelicap_compiler/v1/src/compiler/source_module.dart';
...
/// The bulk of "compilation" for Kelicap's components and templates.
///
...
class KelicapCompiler {
  ...
  static String _moduleUrlFor(KelicapArtifacts artifacts) {
