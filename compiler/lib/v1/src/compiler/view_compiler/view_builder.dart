...
import 'package:kelicap_compiler/v1/src/compiler/view_compiler/bound_value_converter.dart';
import 'package:kelicap_compiler/v1/src/compiler/view_compiler/update_statement_visitor.dart';
...
o.Constructor _createComponentViewConstructor(CompileView view) {
  ...
  final createRootElementExpr = o.importExpr(Identifiers.document).callMethod(
    'createElement',
    [o.literal(tagName)],
  );
