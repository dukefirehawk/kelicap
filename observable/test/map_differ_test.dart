...
void main() {
  group('$MapDiffer', () {
    ...
    test('should detect updates', () {
      expect(
        diff(
          {'key-a': 'value-a', 'key-b': 'value-b-old'},
          {'key-a': 'value-a', 'key-b': 'value-b-new'},
        ),
  ...
  group('$MapChangeRecord', () {
    test('should reply an insertion', () {
      final map1 = {'key-a': 'value-a', 'key-b': 'value-b'};
      final map2 = {'key-a': 'value-a', 'key-b': 'value-b', 'key-c': 'value-c'};
      MapChangeRecord.insert('key-c', 'value-c').apply(map1);
      expect(map1, map2);
    });

    test('should replay a removal', () {
      final map1 = {'key-a': 'value-a', 'key-b': 'value-b', 'key-c': 'value-c'};
      final map2 = {'key-a': 'value-a', 'key-b': 'value-b'};
      MapChangeRecord.remove('key-c', 'value-c').apply(map1);
      expect(map1, map2);
    });

    test('should replay an update', () {
      final map1 = {'key-a': 'value-a', 'key-b': 'value-b-old'};
      final map2 = {'key-a': 'value-a', 'key-b': 'value-b-new'};
